        ...
        <div class="portlet-body">
            <div class="form-body">
                    ...
                    <div class="input-icon right margin-top-10">
                        <select name="lens_id" calss="form-control">
                            @forelse ($lenses as $lens)
                                <option value="{{ $lens->id }}" {{ old('lens_id', $product->lens_id) == $lens->id ? 'selected' : '' }}>{{$lens->name}}</option>
                            @empty
                ...
                <div class="form-group">
                  <label>Name</label>
                    <div class="input-icon right margin-top-10">
                        <textarea name="name" id="" cols="130" placeholder="Lenses Name" calss="form-control">{{ old("name", $product->name) }}</textarea>
                    </div>

                    ...
                    <div class="tab-content">
                      <div class="form-group">
                          ...
                          <div class="input-icon right input-medium margin-top-10">
                              ...
                              <input type="file" name="name" class="form-control" value="{{$blog->photo}}">
                          </div>
                      </div>
                                            ...
                                            <div class="portlet-body form">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right input-medium margin-top-10">
                                                            <i class="fa fa-check"></i>
                                                            <input type="text" name="{{$language->locale}}[title]" class="form-control" value="{{$blog->translate($language->locale)->title}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right input-medium margin-top-10">
                                                            <i class="fa fa-check"></i>
                                                            <textarea name="{{$language->locale}}[description]"  class="form-control" rows="8" cols="80">{{$blog->translate($language->locale)->description}}</textarea>

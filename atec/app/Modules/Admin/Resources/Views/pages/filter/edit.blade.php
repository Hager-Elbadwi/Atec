...
<div class="portlet light portlet-fit portlet-datatable bordered">
    <div class="portlet-body">
      ...
      @endif
            ...
            <form method="POST" action="{{ route('admin.filter.update', $filter->id) }}"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <div class="input-icon right input-medium margin-top-10">
                                                      <label>Name</label>
                                                        <input type="text" name="text" class="form-control" value="{{old('text', $filter->text)}}"> </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-icon right input-medium margin-top-10">
                                                ...
                                                <select name="parent_id" class="form-control">
                                                    ...
                                                    @forelse ($filters as $item)
                                                        ...
                                                        <option value="{{ $item->id }}" {{$item->id == $filter->parent_id? 'selected':''}}>{{ $item->text }}</option>
                                                        {{-- @endif --}}
                                                    @empty

        ...
        <form method="POST" action="{{ route('admin.employees.update', $employee->id) }}">
            ...
            <div class="portlet-body">
               ...
               <div class="form-group">
                  ...
                  <div class="input-icon right input-medium margin-top-10">
                      <i class="fa fa-check"></i>
                      <input type="text" name="password" class="form-control" placeholder="Name" value="{{ $employee->password }}">
                  </div>
              </div>
              ...
              <div class="mt-radio-inline">
                  ...
                  <label class="mt-radio">
                      <input type="radio" name="status" value="0" {{ $employee->status == 0 ? 'checked' : '' }}> Not Active
                      <span></span>
                  </label>
              </div> 
